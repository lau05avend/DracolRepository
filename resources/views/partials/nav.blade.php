...
<body>
            ...
            <div>
                ...
                <div class="nav__list">
                    ...
                    <div class="nav__items">
                        ...
                        <a href="{{ route('diseno.index') }}" class="nav__link">
                            <i class='bx bx-compass nav__icon'></i>
                        ...
                        <div class="nav__dropdown">
                            ...
                            <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="{{ route('material.index') }}" class="nav__dropdown-item">Material</a>
                                </div>
                                </div>
                                <div class="nav__dropdown-collapse">
                                <div class="nav__dropdown-content">
                                    <a href="{{ route('TipoMaterial.index') }}" class="nav__dropdown-item">Tipo de Material</a>
                                </div>
                        ...
                        <a href="{{ route('planilla.index') }}" class="nav__link">
                            <i class='bx bx-compass nav__icon'></i>
    ...
    <script src="https://cdn.jsdelivr.net/npm/bootstrap@5.0.2/dist/js/bootstrap.bundle.min.js" integrity="sha384-MrcW6ZMFYlzcLA8Nl+NtUVF0sA7MsXsP1UyJoMp4YLEuNSfAP+JcXn/tWtIaxVXM" crossorigin="anonymous"></script>    <!-- jsDelivr :: Sortable :: Latest (https://www.jsdelivr.com/package/npm/sortablejs) -->
